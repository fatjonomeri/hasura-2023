    ...
    <BasicPage fullpage title="Badges Status" subtitle="Engineer">
      ...
      <Box sx={{ mt: 2 }}>
        ...
        {currentTab === 1 && <EngineerApplicationsTable applications={applicationsFromEngineer} />} */}
         {currentTab === 0 && approvedProposals.length > 0 && <ManagerProposalsTable proposals={approvedProposals} />}
        {currentTab === 1 && applicationsFromEngineer.length > 0 && <EngineerApplicationsTable applications={applicationsFromEngineer} />}
        {currentTab === 0 && approvedProposals.length === 0 && <Typography>No data available for Proposals From Manager</Typography>}
        {currentTab === 1 && applicationsFromEngineer.length === 0 && <Typography>No data available for Applications from Engineer</Typography>}
      </Box>
    </BasicPage>
  );
};
